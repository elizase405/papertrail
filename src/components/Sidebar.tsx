    ...
    <>
      ...
      `}>
        ...
        <div className="p-4 border-t border-gray-100">
          <div className="minimal-card p-4 bg-gradient-to-br from-gray-50 to-gray-100">
            <p className="text-xs font-medium text-gray-800 mb-1">Stay Compliant</p>
            <p className="text-xs text-gray-600">Track your documents with ease</p>
          </div>
        </div>
      </aside>
    </>
