  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      <div className="relative">
        {/* Background circle */}
        <div className={`${sizeClasses[size]} bg-gradient-to-br from-gray-900 to-gray-700 dark:from-gray-700 dark:to-gray-900 rounded-xl flex items-center justify-center shadow-sm`}>
